...
**表全名**: `srpproduct-dc37e.favie_dw.dim_ad_all_source_history_creative_tag_full_view`
**层级**: 未分类
**业务域**: advertising
**表类型**: EXTERNAL
**行数**: 0 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dim_ad_all_source_history_creative_tag_full_view`
