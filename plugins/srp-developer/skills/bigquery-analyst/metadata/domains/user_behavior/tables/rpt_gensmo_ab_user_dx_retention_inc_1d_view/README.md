...
**表全名**: `srpproduct-dc37e.favie_rpt.rpt_gensmo_ab_user_dx_retention_inc_1d_view`
**层级**: RPT (报表层)
**业务域**: user_behavior
**表类型**: VIEW
**行数**: 0 行
...
- `srpproduct-dc37e.favie_rpt.rpt_gensmo_user_x_retention_metrics_inc_1d` (rpt_gensmo_user_x_retention_metrics_inc_1d)
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_rpt.rpt_gensmo_ab_user_dx_retention_inc_1d_view`
