...
**表全名**: `srpproduct-dc37e.favie_dw.dws_favie_gem_sku_search_cute_inc_1d_view`
**层级**: DWS (汇总层)
**业务域**: search
**表类型**: VIEW
**行数**: 0 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dws_favie_gem_sku_search_cute_inc_1d_view`
