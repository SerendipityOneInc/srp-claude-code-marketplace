...
**表全名**: `srpproduct-dc37e.favie_dw.dws_favie_gem_sku_search_cube_inc_1d_view`
**层级**: DWS (汇总层)
**业务域**: search
**表类型**: VIEW
**行数**: 0 行
...
| user_language | STRING | NULLABLE | - |
| user_device_os | STRING | NULLABLE | - |
| user_type | STRING | NULLABLE | - |
| user_register_type | STRING | NULLABLE | - |
| gem_sku_raw_query_cnt | INTEGER | NULLABLE | - |
| gem_sku_raw_query_uniq_cnt | INTEGER | NULLABLE | - |
| gem_sku_ha3_query_cnt | INTEGER | NULLABLE | - |
| gem_sku_ha3_query_uniq_cnt | INTEGER | NULLABLE | - |
...
| first_gem_moodboard_sku_cnt | INTEGER | NULLABLE | - |
| first_gem_moodboard_sku_uniq_cnt | INTEGER | NULLABLE | - |
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dws_favie_gem_sku_search_cube_inc_1d_view`
