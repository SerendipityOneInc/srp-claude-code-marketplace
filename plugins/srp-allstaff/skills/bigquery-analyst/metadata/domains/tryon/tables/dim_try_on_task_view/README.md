...
**表全名**: `srpproduct-dc37e.favie_dw.dim_try_on_task_view`
**层级**: 未分类
**业务域**: other
**表类型**: VIEW
**行数**: 0 行
...
| outfit_comment | STRING | NULLABLE | - |
...
| cover_image_list | STRING | NULLABLE | - |
