...
**表全名**: `srpproduct-dc37e.favie_rpt.rpt_gensmo_user_active_metrics_inc_1d`
**层级**: RPT (报表层)
**业务域**: user_behavior
**表类型**: TABLE
**行数**: 62,628,387 行
...
| active_user_d1_cnt | INTEGER | NULLABLE | 日活跃用户数-deprecated, use active_user_1d_cnt instead |
| total_duration | FLOAT | NULLABLE | 总停留时长-deprecated, use active_user_1d_duration instead |
| active_user_1d_cnt | INTEGER | NULLABLE | 1日活跃用户数 |
| active_user_7d_cnt | INTEGER | NULLABLE | 7日活跃用户数 |
| active_user_30d_cnt | INTEGER | NULLABLE | 30日活跃用户数 |
| active_user_1d_duration | FLOAT | NULLABLE | 1日活跃用户总停留时长 |
| active_user_7d_duration | FLOAT | NULLABLE | 7日活跃用户总停留时长 |
| active_user_30d_duration | FLOAT | NULLABLE | 30日活跃用户总停留时长 |
