CREATE TABLE `srpproduct-dc37e.favie_rpt.rpt_gensmo_user_active_metrics_inc_1d`
(
  ...
  active_user_d1_cnt INT64 OPTIONS(description="日活跃用户数-deprecated, use active_user_1d_cnt instead"),
  total_duration FLOAT64 OPTIONS(description="总停留时长-deprecated, use active_user_1d_duration instead"),
  active_user_1d_cnt INT64 OPTIONS(description="1日活跃用户数"),
  active_user_7d_cnt INT64 OPTIONS(description="7日活跃用户数"),
  active_user_30d_cnt INT64 OPTIONS(description="30日活跃用户数"),
  active_user_1d_duration FLOAT64 OPTIONS(description="1日活跃用户总停留时长"),
  active_user_7d_duration FLOAT64 OPTIONS(description="7日活跃用户总停留时长"),
  active_user_30d_duration FLOAT64 OPTIONS(description="30日活跃用户总停留时长"),
