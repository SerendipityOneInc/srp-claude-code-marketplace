...
**表全名**: `srpproduct-dc37e.favie_dw.dws_decofy_refer_general_metrics_inc_1d`
**层级**: DWS (汇总层)
**业务域**: decofy
**表类型**: TABLE
**行数**: 563,488 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dws_decofy_refer_general_metrics_inc_1d`
