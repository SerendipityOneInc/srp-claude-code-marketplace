...
**表全名**: `srpproduct-dc37e.favie_rpt.rpt_gensmo_ab_tryon_metrics_inc_1d_view`
**层级**: RPT (报表层)
**业务域**: tryon
**表类型**: VIEW
**行数**: 0 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_rpt.rpt_gensmo_ab_tryon_metrics_inc_1d_view`
