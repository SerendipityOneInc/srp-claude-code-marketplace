...
**表全名**: `srpproduct-dc37e.favie_rpt.rpt_decofy_user_group_penetration_rate_view`
**层级**: RPT (报表层)
**业务域**: decofy
**表类型**: VIEW
**行数**: 0 行
...
| group_user_cnt | INTEGER | NULLABLE | - |
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_rpt.rpt_decofy_user_group_penetration_rate_view`
