...
**表全名**: `srpproduct-dc37e.favie_dw.dim_ad_all_source_creative_unique_full_1d_view`
**层级**: 未分类
**业务域**: advertising
**表类型**: VIEW
**行数**: 0 行
...
| f_creative_category | STRING | NULLABLE | - |
...
| overflow_seq | INTEGER | NULLABLE | - |
| creative_language_tag | STRING | NULLABLE | - |
| tag_source | STRING | NULLABLE | - |
| creative_func_tag | STRING | NULLABLE | - |
| creative_source_tag | STRING | NULLABLE | - |
| creative_race_tag | STRING | NULLABLE | - |
| creative_gender_tag | STRING | NULLABLE | - |
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dim_ad_all_source_creative_unique_full_1d_view`
