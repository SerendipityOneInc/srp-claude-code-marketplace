...
**表全名**: `srpproduct-dc37e.favie_dw.dws_gem_growth_ad_inc_7d_agg_view`
**层级**: DWS (汇总层)
**业务域**: advertising
**表类型**: VIEW
**行数**: 0 行
...
| is_ssot | STRING | NULLABLE | - |
| is_classic | STRING | NULLABLE | - |
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dws_gem_growth_ad_inc_7d_agg_view`
