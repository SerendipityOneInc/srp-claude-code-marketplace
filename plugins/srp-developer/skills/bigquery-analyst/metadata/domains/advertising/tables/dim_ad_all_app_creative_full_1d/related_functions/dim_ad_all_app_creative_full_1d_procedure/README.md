# dim_ad_all_app_creative_full_1d_procedure

**函数全名**: `srpproduct-dc37e.favie_dw.dim_ad_all_app_creative_full_1d_procedure`
**类型**: PROCEDURE
**函数分类**: dimension
**语言**: SQL
**创建时间**: 2025-07-10
...
- `srpproduct-dc37e.favie_dw.dim_ad_all_app_creative_full_1d_function` (dim_ad_all_app_creative_full_1d_function)
- `srpproduct-dc37e.favie_dw.dim_ad_all_app_creative_full_1d` (dim_ad_all_app_creative_full_1d)
