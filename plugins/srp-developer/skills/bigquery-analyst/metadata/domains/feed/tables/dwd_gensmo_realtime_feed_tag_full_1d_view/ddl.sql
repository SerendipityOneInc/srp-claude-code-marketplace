CREATE VIEW `srpproduct-dc37e.favie_dw.dwd_gensmo_realtime_feed_tag_full_1d_view`
AS with moodboard_tag_source_data as (
    ...
    from favie_dw.dwd_gensmo_realtime_feed_tag_full_1d
    where dt is not null and dt = (select max(dt) from favie_dw.dwd_gensmo_realtime_feed_tag_full_1d where dt is not null)
  ),
