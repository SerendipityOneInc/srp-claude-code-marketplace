...
**表全名**: `srpproduct-dc37e.favie_dw.dws_favie_gem_sku_search_cube_inc_1d`
**层级**: DWS (汇总层)
**业务域**: search
**表类型**: TABLE
**行数**: 2,969,905 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dws_favie_gem_sku_search_cube_inc_1d`
