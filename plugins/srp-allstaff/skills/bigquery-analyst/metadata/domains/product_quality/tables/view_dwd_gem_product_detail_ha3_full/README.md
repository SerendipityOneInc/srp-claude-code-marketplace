...
**表全名**: `srpproduct-dc37e.favie_dw.view_dwd_gem_product_detail_ha3_full`
**层级**: 未分类
**业务域**: product_quality
**表类型**: VIEW
**行数**: 0 行
...
| gender_tag | STRING | NULLABLE | - |
| occasion_tag | STRING | NULLABLE | - |
| season_tag | STRING | NULLABLE | - |
| brand_tag | STRING | NULLABLE | - |
| skin_tag | STRING | NULLABLE | - |
| benefits_tag | STRING | NULLABLE | - |
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.view_dwd_gem_product_detail_ha3_full`
