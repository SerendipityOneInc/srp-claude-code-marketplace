...
**表全名**: `srpproduct-dc37e.favie_dw.dwd_gem_base_user_behavior_inc_1d_view`
**层级**: DWD (明细层)
**业务域**: user_behavior
**表类型**: VIEW
**行数**: 0 行
...
- `srpproduct-dc37e.ga_analytics.events_intraday` (events_intraday)
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dwd_gem_base_user_behavior_inc_1d_view`
