...
**表全名**: `srpproduct-dc37e.favie_dw.dwd_growth_ad_all_source_creative_with_supply_inc_1d_view`
**层级**: DWD (明细层)
**业务域**: advertising
**表类型**: VIEW
**行数**: 0 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dwd_growth_ad_all_source_creative_with_supply_inc_1d_view`
