# rpt_favie_gem_search_sku_metric_inc_1d_function

**函数全名**: `srpproduct-dc37e.favie_dw.rpt_favie_gem_search_sku_metric_inc_1d_function`
...
- `srpproduct-dc37e.favie_dw.dim_site_mut_view` (dim_site_mut_view)
