...
**表全名**: `srpproduct-dc37e.favie_dw.dim_gem_appsflyer_appsflyer_history_inc_1d_view`
**层级**: 未分类
**业务域**: gem
**表类型**: VIEW
**行数**: 0 行
...
| attributed_touch_time | TIMESTAMP | NULLABLE | - |
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dim_gem_appsflyer_appsflyer_history_inc_1d_view`
