...
**表全名**: `srpproduct-dc37e.favie_dw.dwd_favie_decofy_subscription_order_inc_1d_view`
**层级**: DWD (明细层)
**业务域**: subscription
**表类型**: VIEW
**行数**: 0 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dwd_favie_decofy_subscription_order_inc_1d_view`
