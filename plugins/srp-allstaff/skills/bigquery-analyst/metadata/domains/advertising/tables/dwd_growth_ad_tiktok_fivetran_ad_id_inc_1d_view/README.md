...
**表全名**: `srpproduct-dc37e.favie_dw.dwd_growth_ad_tiktok_fivetran_ad_id_inc_1d_view`
**层级**: DWD (明细层)
**业务域**: advertising
**表类型**: VIEW
**行数**: 0 行
...
| tiktok_item_id | STRING | NULLABLE | - |
...
- `srpproduct-dc37e.fivetran_tiktok_ads.ad_report_daily` (ad_report_daily)
- `srpproduct-dc37e.fivetran_tiktok_ads.adgroup_history` (adgroup_history)
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dwd_growth_ad_tiktok_fivetran_ad_id_inc_1d_view`
