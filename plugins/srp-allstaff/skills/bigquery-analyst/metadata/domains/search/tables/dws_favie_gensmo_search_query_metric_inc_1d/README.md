...
**表全名**: `srpproduct-dc37e.favie_dw.dws_favie_gensmo_search_query_metric_inc_1d`
**层级**: DWS (汇总层)
**业务域**: search
**表类型**: TABLE
**行数**: 1,500,395 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dws_favie_gensmo_search_query_metric_inc_1d`
