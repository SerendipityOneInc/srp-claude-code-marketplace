CREATE VIEW `srpproduct-dc37e.favie_rpt.rpt_gensmo_ab_user_dx_retention_inc_1d_view`
AS WITH ab_users AS (
        SELECT
            dt,
            user_tenure_type,
            ...
            retention_type,
            SUM(retention_user_cnt) AS retention_user_cnt,
            SUM(active_user_cnt) AS active_user_cnt
        FROM
            srpproduct-dc37e.favie_rpt.rpt_gensmo_user_x_retention_metrics_inc_1d
        WHERE
