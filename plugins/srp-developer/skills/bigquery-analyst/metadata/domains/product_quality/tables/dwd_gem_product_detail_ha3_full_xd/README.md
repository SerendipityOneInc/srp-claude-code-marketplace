...
**表全名**: `srpproduct-dc37e.favie_dw.dwd_gem_product_detail_ha3_full_xd`
**层级**: DWD (明细层)
**业务域**: product_quality
**表类型**: TABLE
**行数**: 28,610,833 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dwd_gem_product_detail_ha3_full_xd`
