...
**表全名**: `srpproduct-dc37e.favie_dw.dim_dwd_gem_feed_tags_full_1d_view`
**层级**: 未分类
**业务域**: feed
**表类型**: VIEW
**行数**: 0 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dim_dwd_gem_feed_tags_full_1d_view`
