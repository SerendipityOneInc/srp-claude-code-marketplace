...
**表全名**: `srpproduct-dc37e.favie_dw.dw_ad_all_source_creative_multiple_full_1d_view`
**层级**: 未分类
**业务域**: advertising
**表类型**: VIEW
**行数**: 0 行
...
| kol_ad_create_at | TIMESTAMP | NULLABLE | - |
| kol_ad_updated_at | TIMESTAMP | NULLABLE | - |
| material_id | STRING | NULLABLE | - |
| video_expire_time | STRING | NULLABLE | - |
| creative_uuid | STRING | NULLABLE | - |
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dw_ad_all_source_creative_multiple_full_1d_view`
