CREATE VIEW `srpproduct-dc37e.favie_dw.dwd_all_app_appsflyer_webhook_v2_inc_1d_view`
...
from (
	...
	(
		SELECT  dt
			   ...
			   ,user_id
			   ,event_time
		FROM `favie_dw.dwd_gem_total_appsflyer_webhook_v2_inc_1d_view`
		...
		SELECT  dt
			   ...
			   ,user_id
			   ,event_time
		FROM `favie_dw.dwd_decofy_total_appsflyer_webhook_v2_inc_1d_view`
         where appsflyer_id is not null 
	)
)
where rn=1
