# dwd_favie_gensmo_events_items_inc_1d_function

**函数全名**: `srpproduct-dc37e.favie_dw.dwd_favie_gensmo_events_items_inc_1d_function`
...
SELECT 
      ...
      FROM `favie_dw.dwd_favie_gensmo_events_inc_1d`
            left outer join unnest(event_items) as event_item
      WHERE dt = dt_param
```
