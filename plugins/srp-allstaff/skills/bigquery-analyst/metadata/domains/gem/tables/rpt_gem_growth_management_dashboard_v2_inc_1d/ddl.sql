CREATE TABLE `srpproduct-dc37e.favie_rpt.rpt_gem_growth_management_dashboard_v2_inc_1d`
(
...
PARTITION BY dt
OPTIONS(
  labels=[("dataplex-data-documentation-published-project", "srpproduct-dc37e"), ("dataplex-data-documentation-published-location", "us-east1"), ("dataplex-data-documentation-published-scan", "afac1b047-1182-4b66-b0c3-75eb33446e5a")]
);