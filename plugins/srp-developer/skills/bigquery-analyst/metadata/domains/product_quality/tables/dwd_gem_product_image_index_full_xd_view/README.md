...
**表全名**: `srpproduct-dc37e.favie_dw.dwd_gem_product_image_index_full_xd_view`
**层级**: DWD (明细层)
**业务域**: product_quality
**表类型**: VIEW
**行数**: 0 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dwd_gem_product_image_index_full_xd_view`
