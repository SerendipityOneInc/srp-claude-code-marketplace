...
**表全名**: `srpproduct-dc37e.favie_rpt.rpt_decofy_user_retention_metrics_inc_1d`
**层级**: RPT (报表层)
**业务域**: user_behavior
**表类型**: TABLE
**行数**: 31,628 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_rpt.rpt_decofy_user_retention_metrics_inc_1d`
