CREATE VIEW `srpproduct-dc37e.favie_dw.favie_product_detail_analysis_bigtable_external_view`
AS SELECT 
  rowkey,
...
FROM( 
  ...
  from favie_dw.favie_product_detail_analysis_bigtable_external
);