# dim_favie_gensmo_feed_need_tag_item_products_inc_1d_function

**函数全名**: `srpproduct-dc37e.favie_dw.dim_favie_gensmo_feed_need_tag_item_products_inc_1d_function`
...
with favie_gensmo_feed_item_explode as (
      select 
        ...
        created_time,
        update_time
      from favie_dw.dim_favie_gensmo_feed_need_tag_item_inc_1d_function(dt_param)
