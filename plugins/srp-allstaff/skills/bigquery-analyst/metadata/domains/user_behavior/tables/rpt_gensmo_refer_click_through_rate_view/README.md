...
**表全名**: `srpproduct-dc37e.favie_rpt.rpt_gensmo_refer_click_through_rate_view`
**层级**: RPT (报表层)
**业务域**: other
**表类型**: VIEW
**行数**: 0 行
...
| refer_ap_click_cnt | INTEGER | NULLABLE | - |
| refer_pv_cnt | INTEGER | NULLABLE | - |
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_rpt.rpt_gensmo_refer_click_through_rate_view`
