# dws_favie_gensmo_user_inc_1d_function

**函数全名**: `srpproduct-dc37e.favie_dw.dws_favie_gensmo_user_inc_1d_function`
...
- `srpproduct-dc37e.favie_mongodb_integration_stitch3_v2.gem_account` (gem_account)
- `srpproduct-dc37e.favie_dw.dim_gem_account_view` (dim_gem_account_view)
- `srpproduct-dc37e.favie_mongodb_integration_stitch3_v2.gem_unregister_account` (gem_unregister_account)
