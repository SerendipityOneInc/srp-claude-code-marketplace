...
**表全名**: `srpproduct-dc37e.favie_rpt.rpt_gensmo_user_action_ltn_metrics_inc_1d`
**层级**: RPT (报表层)
**业务域**: user_behavior
**表类型**: TABLE
**行数**: 26,971,044 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_rpt.rpt_gensmo_user_action_ltn_metrics_inc_1d`
