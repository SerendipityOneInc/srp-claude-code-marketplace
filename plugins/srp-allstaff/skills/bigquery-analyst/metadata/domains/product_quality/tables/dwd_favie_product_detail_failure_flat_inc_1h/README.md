...
**表全名**: `srpproduct-dc37e.favie_dw.dwd_favie_product_detail_failure_flat_inc_1h`
**层级**: DWD (明细层)
**业务域**: product_quality
**表类型**: EXTERNAL
**行数**: 0 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dwd_favie_product_detail_failure_flat_inc_1h`
