...
**表全名**: `srpproduct-dc37e.favie_dw.dwd_gem_product_structured_extraction_demographic_full_1d`
**层级**: DWD (明细层)
**业务域**: product_quality
**表类型**: EXTERNAL
**行数**: 0 行
...
| demographic_v2 | STRING | NULLABLE | - |
| dt | STRING | NULLABLE | - |
| model_version | STRING | NULLABLE | - |
| bucket | STRING | NULLABLE | - |
| world_size | STRING | NULLABLE | - |
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dwd_gem_product_structured_extraction_demographic_full_1d`
