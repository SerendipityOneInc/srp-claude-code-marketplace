CREATE TABLE `srpproduct-dc37e.favie_dw.dws_savyo_growth_ad_metrics_inc_1d`
(
  ...
  app_name STRING OPTIONS(description="应用名称：Savyo"),
  ...
  channel STRING OPTIONS(description="渠道：ON_LINE"),
  attribution_method STRING OPTIONS(description="归因方法：BOTH"),
...
OPTIONS(
  description="Savyo广告指标增量表，包含广告花费、转化、用户行为等指标"
);