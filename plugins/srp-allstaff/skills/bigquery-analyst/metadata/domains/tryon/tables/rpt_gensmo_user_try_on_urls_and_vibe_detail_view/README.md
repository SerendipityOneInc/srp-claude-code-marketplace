...
**表全名**: `srpproduct-dc37e.favie_rpt.rpt_gensmo_user_try_on_urls_and_vibe_detail_view`
**层级**: RPT (报表层)
**业务域**: other
**表类型**: VIEW
**行数**: 0 行
...
| aschange_background_input_image_url | STRING | NULLABLE | - |
| change_background_image_url | STRING | REPEATED | - |
...
- `srpproduct-dc37e.favie_dw.dim_try_on_change_background_task_view` (dim_try_on_change_background_task_view)
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_rpt.rpt_gensmo_user_try_on_urls_and_vibe_detail_view`
