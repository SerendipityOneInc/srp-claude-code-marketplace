...
**语言**: SQL
**完整路径**: `srpproduct-dc37e.favie_dw.dws_favie_product_info_full_1d_function`
...
-- 调用函数生成数据
SELECT *
FROM `srpproduct-dc37e.favie_dw.dws_favie_product_info_full_1d_function`(CURRENT_DATE())
LIMIT 100;
```
...
**创建时间**: 2026-01-30T02:05:45.101000+00:00
**最后修改**: 2026-01-30T02:05:45.101000+00:00
