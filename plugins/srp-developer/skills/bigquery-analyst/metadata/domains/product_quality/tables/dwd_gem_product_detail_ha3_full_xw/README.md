...
**表全名**: `srpproduct-dc37e.favie_dw.dwd_gem_product_detail_ha3_full_xw`
**层级**: DWD (明细层)
**业务域**: product_quality
**表类型**: TABLE
**行数**: 203,189,159 行
...
| created_time | STRING | NULLABLE | 商品创建时间戳：秒 |
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dwd_gem_product_detail_ha3_full_xw`
