...
**表全名**: `srpproduct-dc37e.favie_dw.favie_product_detail_bigtable_external_view`
**层级**: 未分类
**业务域**: product_quality
**表类型**: VIEW
**行数**: 0 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.favie_product_detail_bigtable_external_view`
