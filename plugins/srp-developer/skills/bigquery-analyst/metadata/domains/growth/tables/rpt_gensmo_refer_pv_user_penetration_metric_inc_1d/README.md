...
**表全名**: `srpproduct-dc37e.favie_rpt.rpt_gensmo_refer_pv_user_penetration_metric_inc_1d`
**层级**: RPT (报表层)
**业务域**: other
**表类型**: TABLE
**行数**: 132,353,086 行
...
| refer_user_cnt | INTEGER | NULLABLE | 来源用户数 |
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_rpt.rpt_gensmo_refer_pv_user_penetration_metric_inc_1d`
