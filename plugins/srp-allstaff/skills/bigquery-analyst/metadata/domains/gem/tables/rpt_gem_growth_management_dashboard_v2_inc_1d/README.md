...
**表全名**: `srpproduct-dc37e.favie_rpt.rpt_gem_growth_management_dashboard_v2_inc_1d`
**层级**: RPT (报表层)
**业务域**: gem
**表类型**: TABLE
**行数**: 66,596 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_rpt.rpt_gem_growth_management_dashboard_v2_inc_1d`
