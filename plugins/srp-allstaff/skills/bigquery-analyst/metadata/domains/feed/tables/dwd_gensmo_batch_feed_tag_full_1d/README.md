...
**表全名**: `srpproduct-dc37e.favie_dw.dwd_gensmo_batch_feed_tag_full_1d`
**层级**: DWD (明细层)
**业务域**: feed
**表类型**: EXTERNAL
**行数**: 0 行
...
SELECT
    dt,
    COUNT(*) as cnt
FROM `srpproduct-dc37e.favie_dw.dwd_gensmo_batch_feed_tag_full_1d`
