...
**表全名**: `srpproduct-dc37e.favie_dw.dwd_favie_gensmo_events_inc_1d`
**层级**: DWD (明细层)
**业务域**: other
**表类型**: TABLE
**行数**: 205,155,525 行
...
| event_ab_infos | STRING | REPEATED | - |
...
| cal_pre_refer_event_items | RECORD | REPEATED | 计算得出的前一个来源页面事件相关参数信息 |
| cal_refer_last_event_items | RECORD | REPEATED | 计算得出的来源页面最后一个事件相关参数信息 |
